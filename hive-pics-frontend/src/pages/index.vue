<template>
  <v-container class="pa-0" fluid>
    ...
    <v-row no-gutters>
      <v-col cols="12">
        <v-sheet class="py-12" color="primary">
          <v-container>
        ...
        <v-row>
          ...
          <v-col cols="12" md="4" sm="6">
            <v-card class="bg-transparent" variant="flat">
              <v-card-item>
                <v-card-title>
                  <v-icon class="me-2" color="primary">mdi-thumb-up</v-icon>
                  Like & Interact
                </v-card-title>
                <v-card-text>
          ...
          <v-col cols="12" md="4" sm="6">
            <v-card class="bg-transparent" variant="flat">
              <v-card-item>
                <v-card-title>
                  <v-icon class="me-2" color="primary">mdi-qrcode</v-icon>
                  QR Code Sharing
                </v-card-title>
                <v-card-text>
          ...
          <v-col cols="12" md="4" sm="6">
            <v-card class="bg-transparent" variant="flat">
              <v-card-item>
                <v-card-title>
                  <v-icon class="me-2" color="primary">mdi-zip-box</v-icon>
                  Complete Download
                </v-card-title>
                <v-card-text>
