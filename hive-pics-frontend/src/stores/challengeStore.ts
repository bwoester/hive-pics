...
export const useChallengeStore = defineStore("challenge", () => {
  ...
  const getChallengesInSet = computed(() => (setId: string) => {
    ...
    return set.challengeIds
      .map((id) => getChallengeById.value(id))
  ...
  function updateChallenge(updatedChallenge: Challenge) {
    const index = challenges.value.findIndex(
  ...
  function removeChallenge(id: string) {
    ...
    for (const set of challengeSets.value) {
      set.challengeIds = set.challengeIds.filter(
  ...
  function initializeTestData() {
    ...
    const testChallenges: Challenge[] = [
      ...
      },
      {
        ...
        description:
          "Findet die Person mit dem jüngsten und die mit dem ältesten Geburtsjahr auf der Feier und macht ein gemeinsames Foto von ihnen.",
        reward: 25,
      ...
      },
      {
        ...
        description:
          "Fotografiert das kleinste oder unscheinbarste Detail, das euch an der Dekoration oder den Geschenken auffällt.",
        reward: 15,
      ...
      },
      {
        ...
        description:
          "Sammelt mindestens fünf Leute und fangt ihren ehrlichsten und herzlichsten Lacher in einem Gruppenfoto ein.",
        reward: 20,
      ...
      },
      {
        ...
        description:
          "Macht ein appetitliches Foto vom Buffet oder von einem besonders schön angerichteten Teller.",
        reward: 10,
      ...
      },
      {
        ...
        title: "Kinder-Chaos",
        description:
          "Fangt einen lustigen oder herzerwärmenden Moment der Kinder beim Spielen oder Toben ein.",
        reward: 15,
      ...
      },
      {
        ...
        description:
          "Fotografiert einen Moment, der eine besondere Emotion (Freude, Rührung, Überraschung) einfängt – vielleicht eine Umarmung, ein Blick oder eine Geste.",
        reward: 20,
      ...
      },
      {
        ...
        title: "Socken-Selfie",
        description:
          "Alle Anwesenden, die mitmachen, stellen ihre Füße mit Socken in den Vordergrund und machen ein Selfie davon. Eine lustige Erinnerung!",
        reward: 10,
      ...
      },
      {
        ...
        description:
          "Bildet eine Gruppe und macht ein Foto von euch, das sich in einem Spiegel, einer Scheibe oder einer anderen reflektierenden Oberfläche spiegelt.",
        reward: 15,
      ...
      },
      {
        ...
        description:
          "Jede:r, der:die mitmacht, macht ein Selfie mit einem besonderen Gegenstand oder einer Person, die für die Tauffeier symbolisch ist (z.B. Taufkerze, Taufkleid, ein besonders dekoriertes Detail).",
        reward: 15,
      ...
      },
      {
        ...
        description:
          "Macht ein besonderes und individuelles Porträt vom Taufpaten oder der Taufpatin, das seine/ihre Persönlichkeit widerspiegelt.",
        reward: 20,
    ...
    const testChallengeSets: ChallengeSet[] = [
      ...
      },
      {
        ...
        name: "Taufe",
        description:
          "Besondere Foto-Challenges, um die Taufe deines Kindes festzuhalten.",
        challengeIds: [
